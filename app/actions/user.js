            ...
            .then((list) => {
                if (list.resultCode == 0) {
                    ...
                    const source = {
                        ...
                        income: userInfo.totalRevenue/100,
                        totalRevenue: userInfo.totalRevenue/100,
                        estimatedRebate: userInfo.estimatedRebate/100,
                        availableRebate: userInfo.availableRebate/100,
                        processingWithdraw: userInfo.processingWithdraw/100,
