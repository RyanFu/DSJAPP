...
class About extends React.Component {
    constructor(props) {
        ...
        this.state = {
            version: pkg.version ? pkg.version : '1.1.0'
        };
    }
            ...
            <TouchableWithoutFeedback style={{flex: 1}}>
                ...
                <View style={[styles.container, Platform.OS === 'android' ? null : {marginTop: 21}]}>
                    ...
                    <View style={styles.content}>
                        ...
                        <TouchableHighlight
                            onPress={() => this._gotoH5Page('功能说明', 'http://www.duoshouji.com/#mu-feature')}>
                        ...
                        <TouchableHighlight
                            onPress={() => this._gotoH5Page('常见问题', 'http://www.duoshouji.com/#mu-faq')}>
                            <View style={styles.row}>
                        ...
                        <TouchableHighlight
                            onPress={() => this._gotoH5Page('联系我们', 'http://www.duoshouji.com/#mu-contact')}>
                            <View style={styles.row}>
