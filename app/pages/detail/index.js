                ...
                <ScrollView style={styles.main}>
                    ...
                    </View>
                    {
                        marks.length > 0 ? (
                            marks.map((val, key)=> {
                                return (
                                    <View style={[styles.block, styles.recommendByUser]} key={'recommend'+key}>
                                        <View style={styles.blockTitle}>
                                            <Text style={styles.blockTitleText}>作者推荐商品</Text>
                                        </View>
                                        <TouchableOpacity
                                            onPress={() => {this._jumpToWebview(val)}}
                                            ...
                                            <View style={styles.recContent}>
                                                ...
                                                <View style={styles.recPriceFrame}>
                                                    <Text style={[styles.baseText,styles.recPrice]}>{val.price?'￥'+val.price:''}</Text>
                                                </View>
